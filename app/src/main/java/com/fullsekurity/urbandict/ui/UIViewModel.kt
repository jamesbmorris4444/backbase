...
class UIViewModel(val activity: Application) : AndroidViewModel(activity) {
    ...
    val citysItemTextColor: ObservableField<String> = ObservableField("#ffffff")
    val citysItemTextSize: ObservableField<Float> = ObservableField(0f)
    val citysItemTextTypeface: ObservableField<String> = ObservableField("")
    ...
    val incorrectCityTextColor: ObservableField<String> = ObservableField("#ffffff")
    val incorrectCityTextSize: ObservableField<Float> = ObservableField(0f)
    val incorrectCityTextTypeface: ObservableField<String> = ObservableField("")
    ...
    private fun themeSwitcher(theme: MainActivity.UITheme) {
        uiDataClass?.let { uiDataClass ->
            ...
            citysItemTextColor.set(colorMapper.map(theme, uiDataClass.citysItemTextColor))
            citysItemTextSize.set(textSizeMapper.map(theme, uiDataClass.citysItemTextSize))
            citysItemTextTypeface.set(typefaceMapper.map(theme, uiDataClass.citysItemTextSize))
            ...
            incorrectCityTextColor.set(colorMapper.map(theme, uiDataClass.incorrectCityTextColor))
            incorrectCityTextSize.set(textSizeMapper.map(theme, uiDataClass.incorrectCityTextSize))
            incorrectCityTextTypeface.set(typefaceMapper.map(theme, uiDataClass.incorrectCityTextSize))
