...
class UIDataClass(
    ...
    val citysItemTextColor: String,                    // City item text color
    val citysItemTextSize: String,                     // City item text size
    val wordItemTextColor: String,                        // City word item text color
    val wordItemTextSize: String,                         // City word item text size
    val definitionItemTextColor: String,                  // City definition item text color
    ...
    val incorrectCityTextColor: String,                // Reassociate donor label text color
    val incorrectCityTextSize: String,                 // Reassociate donor label text size
